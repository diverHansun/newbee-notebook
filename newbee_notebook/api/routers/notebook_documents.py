...
from newbee_notebook.api.dependencies import get_notebook_document_service
from newbee_notebook.api.models.requests import AddNotebookDocumentsRequest
...
from newbee_notebook.application.services.notebook_document_service import (
