...
from newbee_notebook.core.rag.embeddings.zhipu import build_embedding
from newbee_notebook.core.rag.indexing import build_index_if_not_exists
from newbee_notebook.core.memory import build_chat_memory
from newbee_notebook.core.rag.generation.chat_engine import build_chat_engine
from newbee_notebook.core.agent.agent import NewbeeNotebookAgent
from newbee_notebook.core.common.config import get_documents_directory, get_index_directory
...
def main():
    ...
    # Create Agent
    print("\n7. Creating NewbeeNotebookAgent...")
    agent = NewbeeNotebookAgent(llm=llm, chat_engine=chat_engine)
