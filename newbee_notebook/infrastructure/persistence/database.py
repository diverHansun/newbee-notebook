...
def get_runtime_schema_statements() -> list[str]:
    return [
        ...
        """,
        """
        CREATE INDEX IF NOT EXISTS idx_video_summaries_notebook_id
        ON video_summaries(notebook_id)
        """,
        """
        ...
        """,
        """
        CREATE INDEX IF NOT EXISTS idx_video_summaries_document_ids
        ON video_summaries USING GIN(document_ids)
        """,
    ]
