"""
Newbee Notebook - Reference Repository Implementation
...
from newbee_notebook.domain.repositories.reference_repository import ReferenceRepository
from newbee_notebook.infrastructure.persistence.models import ReferenceModel
