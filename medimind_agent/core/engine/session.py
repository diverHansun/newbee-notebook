...
from medimind_agent.infrastructure.session import (
    ChatSessionStore,
    ChatSession,
    ChatMessage,
...
class SessionManager:
    ...
    async def chat(
        ...
        if self._session_store and self._current_session:
            # Import ChatMessage from medimind_agent.infrastructure.session
            from medimind_agent.infrastructure.session import ChatMessage as SessionChatMessage
