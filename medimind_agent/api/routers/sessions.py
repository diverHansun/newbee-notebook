"""
MediMind Agent - Sessions Router
...
from medimind_agent.api.models.requests import CreateSessionRequest
from medimind_agent.api.models.responses import (
    SessionResponse,
    SessionListResponse,
    PaginationInfo,
)
from medimind_agent.api.dependencies import get_session_service
from medimind_agent.application.services.session_service import (
    SessionService,
