...
export const uiStrings = {
  ...
  tools: {
    ...
    editFile: { zh: "编辑文件", en: "Edit file" },
    writeFile: { zh: "写入文件", en: "Write file" },
  ...
  chat: {
    ...
    imageUploading: { zh: "上传中", en: "Uploading" },
    imageUploadFailed: { zh: "上传失败", en: "Failed" },
    retryImageUpload: { zh: "重试上传图片", en: "Retry image upload" },
    removeUploadedImage: { zh: "移除上传图片", en: "Remove uploaded image" },
    imageUnsupportedMime: { zh: "仅支持 PNG、JPG、WebP 图片", en: "Only PNG, JPG, and WebP images are supported." },
    imageOversize: { zh: "单张图片不能超过 10 MB", en: "Each image must be 10 MB or smaller." },
    imageCountExceeded: { zh: "每条消息最多添加 10 张图片", en: "A message can include up to 10 images." },
    imageMissingSession: { zh: "请先创建会话后再上传图片", en: "Create a chat session before uploading images." },
    imageUploadFailedDetail: { zh: "图片上传失败，请重试", en: "Image upload failed. Please retry." },
  },
  messageStatus: {
  ...
  controlPanel: {
    ...
    confirmDeleteSkill: { zh: "确定删除 {name} skill 吗？", en: "Delete {name} skill?" },
  },
  dataPanel: {
    title: { zh: "数据", en: "Data" },
    notebookExport: { zh: "Notebook 归档导出", en: "Notebook Archive Export" },
    notebookExportDesc: {
      zh: "搜索并选择一个或多个 Notebook，逐个下载归档 ZIP。",
      en: "Search and select one or more notebooks, then download archive ZIPs one by one.",
    },
    searchNotebook: { zh: "搜索 Notebook", en: "Search notebooks" },
    selectedNotebookCount: { zh: "已选 {n} 个 Notebook", en: "{n} notebook(s) selected" },
    noNotebooks: { zh: "暂无可导出的 Notebook", en: "No notebooks available for export" },
    currentNotebook: { zh: "当前 Notebook", en: "Current notebook" },
    contentTypes: { zh: "包含内容", en: "Include content" },
    documents: { zh: "解析后的文档", en: "Parsed documents" },
    notes: { zh: "笔记", en: "Notes" },
    marks: { zh: "书签", en: "Bookmarks" },
    diagrams: { zh: "图表源码", en: "Diagram source" },
    videoSummaries: { zh: "视频总结", en: "Video summaries" },
    selectAll: { zh: "全选", en: "Select all" },
    deselectAll: { zh: "取消全选", en: "Deselect all" },
    exportArchive: { zh: "导出所选 Notebook 归档 (.zip)", en: "Export selected notebooks (.zip)" },
    exportArchiveLoading: { zh: "导出中...", en: "Exporting..." },
    exportProgress: { zh: "已完成 {done}/{total}", en: "{done}/{total} completed" },
    exportSuccessCount: { zh: "成功导出 {n} 个 Notebook", en: "Successfully exported {n} notebook(s)" },
    exportFailedList: { zh: "以下 Notebook 导出失败", en: "Failed notebook exports" },
  },
  selectionMenu: {
  ...
  policyPermission: {
    ...
    createSessionFirst: { zh: "请先创建会话后再切换权限", en: "Create a session before changing policy" },
    updateFailed: { zh: "权限切换失败，请重试。", en: "Policy update failed. Try again." },
  },
  explainCard: {
    titleExplain: { zh: "解释", en: "Explain" },
    titleConclude: { zh: "总结", en: "Summarize" },
    titleDefault: { zh: "解释 / 总结", en: "Explain / Summarize" },
    expandTitle: { zh: "点击展开解释/总结面板", en: "Click to expand explain/summarize panel" },
    collapseTitle: { zh: "点击收起解释/总结面板", en: "Click to collapse explain/summarize panel" },
    clickToExpand: { zh: "点击展开", en: "Click to expand" },
    loading: { zh: "生成中...", en: "Generating..." },
    selectHint: { zh: "选中文档中的文本，点击「解释」或「总结」", en: "Select text in the document, then click Explain or Summarize." },
    close: { zh: "关闭面板", en: "Close panel" },
    createSessionFirst: { zh: "请先创建会话", en: "Please create a session first" },
    quotedTextLabel: { zh: "选中文本", en: "Selected text" },
    emptyTitle: { zh: "还没有内容", en: "Nothing yet" },
    emptyHint: {
      zh: "在文档中选中一段文字，然后点击「解释」或「总结」",
      en: "Select text in the document, then click Explain or Summarize",
    },
    errorTitle: { zh: "生成失败", en: "Generation failed" },
    errorRetry: { zh: "重试", en: "Retry" },
    errorGeneric: { zh: "出现了点问题，请重试", en: "Something went wrong, please retry" },
  },
    studio: {
    ...
    diagramTypeEcharts: { zh: "数据图表", en: "ECharts" },
    ...
    inlineChart: {
      titleFallback: { zh: "ECharts 图表", en: "ECharts chart" },
      saveToStudio: { zh: "保存到 Studio", en: "Save to Studio" },
      saved: { zh: "已保存到 Studio", en: "Saved to Studio" },
      saving: { zh: "保存中...", en: "Saving..." },
      saveFailed: { zh: "保存失败：{detail}", en: "Save failed: {detail}" },
      loading: { zh: "等待图表内容...", en: "Waiting for chart content..." },
      parseError: { zh: "图表内容解析失败", en: "Chart content parse failed" },
      renderError: { zh: "图表渲染失败：{detail}", en: "Chart render failed: {detail}" },
    },
    video: {
  ...
  libraryPage: {
    ...
    typeFilterActiveCount: { zh: "已选 {n} 类", en: "{n} selected" },
      ...
      typeGroupWeb: { zh: "网页", en: "HTML" },
      typeGroupImage: { zh: "图片", en: "Images" },
