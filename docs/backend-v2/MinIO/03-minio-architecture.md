...
- 手动删除测试数据
- 替代文件管理器直接浏览 `data/documents/` 的角色
...
# 从宿主机复制文件到 MinIO (数据迁移用)
docker exec newbee-minio mc cp /data/documents/393f579b-.../markdown/content.md local/documents/393f579b-.../markdown/content.md
```
